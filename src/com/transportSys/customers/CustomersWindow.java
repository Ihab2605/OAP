...
public class CustomersWindow {
	...
	// Represents the main frame of the Products window
	JFrame frame;

	// The table displaying product information
	...
	private void initialize() {
		...
		KeyAdapter searchAdapter = new KeyAdapter() {
			...
			public void keyReleased(KeyEvent arg0) {
				searchProducts(textAreaSearchcustomerNumber.getText(), textAreaSearchcustomerName.getText(),
	...
	/**
	 * Searches the products table using specified criteria for filtering.
	 * 
	...
	private void searchProducts(String customerNumberSearchText, String customerNameSearchText,
