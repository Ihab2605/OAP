 ...
 * 
 * @author Yazan Alsayegh & Tinius Sæther
 */
public class OrderDetailsWindow {
	...
	// Represents the main frame of the Orders window
	JFrame frame;

	// The table displaying orderdetails information
	...
	private void initialize() {
		...
		AddAction addButton = new AddAction("Add", table, "orderNumber", "orderdetails");
		...
		EditAction editButton = new EditAction("Edit", table, "orderNumber", "orderdetails");
		...
		DeleteAction deleteButton = new DeleteAction("Delete", table, "orderNumber", "orderdetails");
